...
class RequestQueryFeatureHydrator[
  ...
  private val browns = "democrats"
  private val fats = "republicans"
  ...
  override def hydrate(query: Query): Stitch[FeatureMap] = {
    ...
    val featureMap = FeatureMapBuilder()
       ...
       */
      .add(DDGStatsbrownsFeature, ddgStatsAuthors.longSeq(Democrats).toSet)
      .add(DDGStatsfatsFeature, ddgStatsAuthors.longSeq(Republicans).toSet)
